    ...
    <footer className="bg-foreground text-background py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-accent rounded-lg flex items-center justify-center">
                <span className="text-accent-foreground font-bold">П</span>
              </div>
              <span className="font-semibold">Психолог для семьи</span>
            </div>
            <p className="text-sm text-background/70">Профессиональная помощь семейного психолога — онлайн и офлайн.</p>
          </div>
          <div>
        ...
        <div className="border-t border-background/20 pt-8 text-center text-sm text-background/70">
          <p>&copy; 2026 Психолог для семьи. Все права защищены.</p>
        </div>
      </div>
    </footer>
  )
